...
for (method in method_array){
  ...
  path_Fscore_Average = paste(Evaluate_path,toString(rep),"/","_Fscore_Correct_Average_",method,".csv",sep = "")
...
save_plot("Evaluate_F1score_Correct_OpenmaxWithLCAnd_Alexnet.png", dummy_plot, base_asp = 1,base_height = 7)
save_plot("Evaluate_F1score_Correct_OpenmaxWithLCAnd_Alexnet.eps", dummy_plot, base_asp = 1,base_height = 7)


########### F2
dataplot_2 = melt(data=as.data.table(data_FScore_all),id.vars = c("indexsampling","method"))
dataplot_2 = dataplot_2[which(dataplot_2$variable %in% c("F2")),]

dummy_plot  = plotformat(dataplot_2,"Q2",xlabel="Comfort ratio",ylabel="Performance index (Q2)")
dummy_plot
save_plot("Evaluate_F2score_Correct_OpenmaxWithLCAnd_Alexnet.png", dummy_plot, base_asp = 1,base_height = 7)
save_plot("Evaluate_F2score_Correct_OpenmaxWithLCAnd_Alexnet.eps", dummy_plot, base_asp = 1,base_height = 7)
