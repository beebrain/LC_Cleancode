...
for (method in method_array){
  for (index_sam in seq(1:4)){
    ...
    data_presision_TP_S = data_presision_TP[,3:1002]
    data_presision_FP_S = data_presision_FP[,3:1002]
    data_presision_FN_S = data_presision_FN[,3:1002]
    
    ############# data TP FP FN of UnSeen ################
    data_presision_TP_u = data_presision_TP$X1001
    data_presision_FP_u = data_presision_FP$X1001
    data_presision_FN_u = data_presision_FN$X1001
    
    ############# data TP FP FN of HackImage ################
    data_presision_TP_f = data_presision_TP$X1002
